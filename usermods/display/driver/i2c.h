 ...
 *        @note
 *        Only slave mode will use this value, driver will ignore this value in master mode.
 * @param busy use busy flag
 *            After master writes some data to slave buffer,
 *            busy flag (bit 8 in last byte of the slave buffer) will be set to 1
 *        @note
 *        Only slave mode will use this value, driver will ignore this value in master mode.
...
/**
 * @brief Reset busy flag in slave buffer
 *        @note
 *        Only call this function in I2C slave mode
 *
 * @param i2c_num I2C port number
